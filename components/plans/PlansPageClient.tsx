      ...
      <div className="flex items-center justify-between gap-4">
        ...
        {canManage && (
          <button
            ...
            className="flex items-center gap-1.5 rounded-xl px-3 py-2 text-xs font-semibold text-zinc-500 dark:text-zinc-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 hover:text-zinc-700 dark:hover:text-zinc-200 transition-colors shrink-0 cursor-pointer"
          >
        ...
        >
          <div className="relative w-full max-w-3xl rounded-3xl bg-white dark:bg-zinc-900 shadow-2xl p-6 overflow-hidden max-h-[90vh] flex flex-col animate-scale-in">
            ...
            <div className="flex items-center justify-between mb-5 shrink-0">
              <h3 className="text-base font-bold text-zinc-900 dark:text-zinc-100">Pricing</h3>
              <button

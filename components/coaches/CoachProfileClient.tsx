...
function CoachFormModal({
  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      ...
      if (result.success) {
        onSaved(result.message ?? "Coach updated successfully");
        onClose();
      } else {
        ...
        <div className="space-y-4 min-w-0">
          ...
          <div className="rounded-3xl bg-white dark:bg-zinc-900 p-5 shadow-sm space-y-4">
            ...
            <div className={showLogs ? "grid gap-6 md:grid-cols-[1fr_260px]" : "w-full"}>
              ...
              <div className="flex flex-col min-w-0 justify-between">
                <div ref={scrollContainerRef} className="flex gap-6 overflow-x-auto pb-4 scrollbar-thin snap-x">
          ...
          <div className="space-y-4">
            {paymentMonths.map((monthVal) => {
              ...
              const totalPay = coach.fixedSalary + totalRevenueThisMonth;
              ...
              return (
                <div key={paymentKey} className="rounded-2xl bg-zinc-50 dark:bg-zinc-800/50 overflow-hidden border border-zinc-100 dark:border-zinc-800 shadow-sm">
                  ...
                  <div className="px-4 py-3 space-y-3 text-sm">
                    ...
                    ) : filteredEarningsForMonth.length > 0 ? (

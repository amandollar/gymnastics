        ...
        {options.map((opt) => {
          ...
          return (
            <button
              ...
              className={`flex items-center justify-center gap-1.5 transition-all duration-200 cursor-pointer h-8 ${
                isActive
                  ? "flex-1 bg-white dark:bg-zinc-700 text-zinc-900 dark:text-zinc-100 shadow-xs px-2.5 rounded-md text-xs font-semibold"
                  : "px-4 shrink-0 text-zinc-500 dark:text-zinc-400 hover:text-zinc-900 dark:hover:text-zinc-200 hover:bg-white/40 dark:hover:bg-zinc-700/20 rounded-md"
              }`}

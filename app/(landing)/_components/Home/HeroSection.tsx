      ...
      {text.split("").map((char, index) => {
        ...
        return (
          <span
            ...
            style={{
              animationDelay: `${startDelay + index * 0.03}s`,
            }}
          >
            {isSpace ? "\u00A0" : char}
          </span>
...
export default function HeroSection() {
  return (
    <div className="relative w-full flex-1 flex items-center min-h-[85vh] sm:min-h-screen overflow-hidden">
      ...
      >
        <source src="/videos/Welcome%20to%20WCC.webm" type="video/webm" />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-12 md:pl-[6vw] md:px-0 md:mx-0 md:max-w-none">
        <style
          ...
          .reveal-char {
            opacity: 0;
            animation: reveal-char 3.5s cubic-bezier(0.05, 0.95, 0.1, 1) forwards;
          }
        `,
          }}
        />
